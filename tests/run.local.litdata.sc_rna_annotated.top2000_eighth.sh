...
suffix_trn=eighth
datadir_trn=$DATA_HOME/raw_df/scRNA/GSE226097_Annotated_split_${suffix_trn}
datadir_valtst=$DATA_HOME/raw_df/scRNA/GSE226097_Annotated_split_strata
...
specify_features=${datadir_valtst}/$top_x/top2000_train_${seed}_rna.csv
...
outputdir=$DATA_HOME/optimized_data/sc_rna_annotated_minmi${minmi}_${top_x}_${suffix_trn}/seed_$seed
