...
outputdir=$DATA_HOME/optimized_data/sc_rna_annotated/seed_$seed

echo "Running optimization for seed $seed"
$mypython run_04_optimize_data.py --trn_npz $ds1_trn --val_parquet $ds1_val --tst_parquet $ds1_tst --labels $label_df --bs 2 --output_dir $outputdir --thre_mi $minmi
