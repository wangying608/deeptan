...
mypython=python
myscript=run_05_fit_tune.diffpool.py

optdata=sc_rna_annotated_minmi0.1_top2000
folder=seed_46
...
$mypython $myscript --data $dirlitdata --bs $bs --logdir $dirlogs --nt $ntrial --nj $njob --agb $agd --ck $ck --dev 1
