#!/bin/bash
#JSUB -J deeptan_sc_rna_annotated_s46
#JSUB -q gpu
#JSUB -n 1
#JSUB -gpgpu '1 mig=1'
#JSUB -o log_out.%J
...
--nv $SIF sh -c "export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True && mkdir -p $dirlogs && python $myscript --data $dirlitdata_v --bs $bs --logdir $dirlogs --nt $ntrial --nj $njob --agb $agd --ck $ck --atune"
