...
label_df=$DATA_HOME/raw_df/snRNA/ath_snrna_balanced_flower_seedling_rosette_celltypes_onehot.parquet
...
outputdir=$DATA_HOME/optimized_data/snrna_${suffix_trn}/seed_$seed
