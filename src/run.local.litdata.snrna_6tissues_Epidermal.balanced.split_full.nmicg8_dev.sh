...
nmic_g=nmicg8
litdata_name=snrna_6tissues_Epidermal.balanced.full.${nmic_g}_dev
...
$mypython run_04_litdata.py --trn_npz $ds1_trn --val_parquet $ds1_val --tst_parquet $ds1_tst --labels $label_df --output_dir $outputdir --in_obs $specify_obs
