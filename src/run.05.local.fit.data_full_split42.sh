...
DEEPTAN_HOME=/mnt/hdd2/homext/xn2p
mypython=python
myscript=run_05_fit_tune.py

optdata=ath_pretrain.full.nmicg8
folder=seed_42
task_name=multitask
ntrial=20
njob=1
...
$mypython $myscript --data $dirlitdata --bs $bs --logdir $dirlogs --nt $ntrial --nj $njob --agb $agd --ck $ck --dev $devices --nog --ir # --atune
