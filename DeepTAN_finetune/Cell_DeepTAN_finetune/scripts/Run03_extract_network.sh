...
#
# Purpose:
#   Extract a cell-specific latent gene network from a cell-type fine-tuned
#   DeepTAN checkpoint.
#
# Pipeline position:
...
#
# Usage:
#   1. Edit Section 1 paths, or pass a config path as the first argument.
#
#   2. Make this script executable:
#        chmod +x 03_extract_cell_network.sh
#
#   3. Run:
#        bash 03_extract_cell_network.sh cell_network_single.yaml
#
...
# Run03 Python script.
RUN03_SCRIPT="/path/to/run_03_extract_cell_network_userfriendly.py"

# Default config file. This can be overridden by passing a config path as $1.
DEFAULT_CONFIG_FILE="/path/to/cell_network_single.yaml"
...
LOG_DIR="${LOG_DIR:-logs/run03_cell_network}"
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_DIR}/run03_extract_cell_network_$(date +%Y%m%d_%H%M%S).log"
...
echo "=============================================================================="
echo "Run03 | Extract Cell-Specific DeepTAN Network"
...
echo "  output_dir/csn/csn_edge_table.parquet"
echo "  output_dir/csn/csn_metadata.yaml"
echo "  output_dir/csn/mean_embeddings_pretrained.npy"
echo "  output_dir/csn/mean_embeddings_finetuned.npy"
echo "  output_dir/csn/cell_embeddings_finetuned.npy"
echo "=============================================================================="
