...
task_name = "multitask"
# ckpt_name = os.path.join("DeepTAN_20250601132049_1rJcw", "best-model-epoch=0005-val_loss=0.0000.ckpt")
ckpt_name = os.path.join("DeepTAN_20250604165036_qCFq8", "best-model-epoch=0005.ckpt")
batch_size = 64
