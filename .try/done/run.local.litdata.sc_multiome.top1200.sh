...
do
specify_features=${datadir}/topxxxx/test${seed}_top2000_${top_x}_features.csv
...
outputdir=$DATA_HOME/optimized_data/sc_multiome_minmi${minmi}_${top_x}/seed_$seed

echo "Running optimization for seed $seed"
$mypython run_04_optimize_data.py --trn_npz $ds1_trn --val_parquet $ds1_val --tst_parquet $ds1_tst --labels $label_df --output_dir $outputdir --thre_mi $minmi --in_feat $specify_features --onlytest
