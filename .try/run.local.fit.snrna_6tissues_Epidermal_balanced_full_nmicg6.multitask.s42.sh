...
optdata=snrna_6tissues_Epidermal.balanced.full.nmicg6
folder=seed_42
task_name=multitask
ntrial=20
njob=1
...
$mypython $myscript --data $dirlitdata --bs $bs --logdir $dirlogs --nt $ntrial --nj $njob --agb $agd --ck $ck --dev $devices
